...
(function () {
  ...
  const T = {
    fr: {
      ...
      nav_shop: "Boutique", nav_wiki: "Wiki", nav_worlds: "Mondes",
      btn_discord: "Discord", btn_copy: "Copier",

      /* titres d'onglet */
      title_home: "Tryzaria Survival — Serveur Minecraft survie 2.0 (1.21.4+)",
      title_votes: "Voter pour Tryzaria — Survie révolutionnaire",
      title_shop: "Boutique — Grades, packs & caisses | Tryzaria Survival",
      title_wiki: "Wiki — Boss, mondes, caisses & FAQ | Tryzaria Survival",

      /* hero */
      hero_eyebrow: "Survie révolutionnaire · Java & Cracked · 1.21.4+",
      hero_title: 'Tryzaria : la survie qui casse la <span class="g">routine vanilla</span>.',
      ...
      boss_sub: "Oublie les zombies qui traînent. Ici, des créatures faites main t'attendent, chacune avec ses mécaniques, ses attaques et son loot légendaire — et aucune ne se laissera terrasser facilement. Réunis ton équipe, forge ton meilleur stuff, et pars à la chasse aux cinq menaces de Tryzaria. Sauras-tu tous les vaincre ?",
      ...
      boss_ancient_name: "Gardien Ancestral", boss_ancient_el: "Ancien",
      boss_minotaur_name: "Minotaure", boss_minotaur_el: "Brute",
      worlds_eyebrow: "3 dimensions",
      worlds_title: "Explore des mondes custom",
      worlds_sub: "Overworld, Nether, End — chaque dimension a été retravaillée pour l'exploration. Trois ambiances, trois défis, un seul serveur.",
      world_over_name: "Un Overworld vivant",
      world_over_desc: "Des biomes retravaillés, une flore et une faune custom, des paysages à couper le souffle. L'Overworld comme tu ne l'as jamais vu.",
      world_nether_name: "Un Nether sous tension",
      world_nether_desc: "Plonge dans des cavernes hostiles aux teintes pourpres, entre lave, créatures et trésors. Chaque pas peut être le dernier.",
      world_end_name: "Un End mystérieux",
      world_end_desc: "Au-delà du vide, des îles flottantes, des cités oubliées et des secrets qui n'attendent que les plus braves.",
      ...
      join2_d: "Multijoueur → Ajouter un serveur → colle l'adresse <code>play.tryzaria.fr</code>.",
      ...
      wk_faq1_a: "Oui — Java officiel et Cracked sont acceptés, même IP : play.tryzaria.fr.",
    ...
    en: {
      ...
      nav_shop: "Shop", nav_wiki: "Wiki", nav_worlds: "Worlds",
      btn_discord: "Discord", btn_copy: "Copy",

      title_home: "Tryzaria Survival — Minecraft Survival 2.0 Server (1.21.4+)",
      title_votes: "Vote for Tryzaria — Revolutionary survival",
      title_shop: "Shop — Ranks, packs & crates | Tryzaria Survival",
      title_wiki: "Wiki — Bosses, worlds, crates & FAQ | Tryzaria Survival",

      hero_eyebrow: "Revolutionary survival · Java & Cracked · 1.21.4+",
      hero_title: 'Tryzaria: survival that breaks the <span class="g">vanilla routine</span>.',
      ...
      boss_sub: "Forget the zombies wandering around. Here, handcrafted creatures await — each with its own mechanics, attacks and legendary loot, and none will go down easy. Gather your squad, forge your best gear, and hunt down the five threats of Tryzaria. Can you defeat them all?",
      ...
      boss_ancient_name: "Ancestral Guardian", boss_ancient_el: "Ancient",
      boss_minotaur_name: "Minotaur", boss_minotaur_el: "Brute",
      worlds_eyebrow: "3 dimensions",
      worlds_title: "Explore custom worlds",
      worlds_sub: "Overworld, Nether, End — every dimension reworked for exploration. Three vibes, three challenges, one server.",
      world_over_name: "A living Overworld",
      world_over_desc: "Reworked biomes, custom flora and fauna, breathtaking landscapes. The Overworld like you've never seen it.",
      world_nether_name: "A Nether on edge",
      world_nether_desc: "Dive into hostile purple-tinted caverns between lava, creatures and treasure. Every step could be your last.",
      world_end_name: "A mysterious End",
      world_end_desc: "Beyond the void: floating islands, forgotten cities and secrets waiting for the bravest.",
      ...
      join2_d: "Multiplayer → Add server → paste <code>play.tryzaria.fr</code>.",
      join3_t: "Jump in",
      ...
      wk_faq1_a: "Yes — official Java and Cracked are both accepted, same IP: play.tryzaria.fr.",
